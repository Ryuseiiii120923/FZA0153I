<div x-data="{ openAddDefect: false }"  @close-add-defect.window="openAddDefect = false" class="bg-white rounded-lg w-full max-w-1xl mx-auto py-4 @if($locked) opacity-50 cursor-not-allowed @endif">
