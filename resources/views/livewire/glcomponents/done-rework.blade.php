<div x-data="{ openAddDoneRework: false }" class="bg-white rounded-lg w-full max-w-1xl mx-auto py-4 @if($locked) opacity-50 cursor-not-allowed @endif">
                ...
                <table class="table-auto w-9/12 text-sm text-white rounded-lg bg-gray-800 overflow-hidden mx-auto">
                    <thead class="bg-gray-900 text-white text-left">
                        <tr>
                            ...
                            <th class="px-4 py-2">Total NG Quantity</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">{{ $data->total_defect ?? 0 }}</td>
