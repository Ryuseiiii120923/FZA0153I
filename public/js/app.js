...
window.Swal = sweetalert2__WEBPACK_IMPORTED_MODULE_4__;
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])("#inspectDate", {
    dateFormat: "Y-m-d",
    // matches wire:model format
  ...
  window.addEventListener("ppf-valid", function () {
    if (window.hasError) {
  ...
  function resetActionButtons() {
    ...
    submitbtn.classList.remove("bg-green-700", "hover:bg-green-800", "focus:outline-none", "focus:ring-4", "focus:ring-green-300", "bg-blue-700", "hover:bg-blue-800", "focus:outline-none", "focus:ring-4", "focus:ring-blue-300", "bg-red-700", "hover:bg-red-800", "focus:outline-none", "focus:ring-4", "focus:ring-red-300", "bg-yellow-900", "scale-95", "shadow-inner", "transition-all", "border-2", "border-double", "border-yellow-400");
    buttons.forEach(function (id) {
      var btn = document.getElementById(id);
      if (!btn) return;
      btn.classList.remove("scale-95", "shadow-inner", "border-2", "border-double", "border-green-400", "border-blue-400", "border-red-400", "bg-green-900", "bg-blue-900", "bg-red-900");
    });
  }
  window.addEventListener("enable-buttons", function () {
    enableButtons();
    // lockAction();
  });
  ...
  window.addEventListener("deletebutton", function () {
    resetActionButtons();
  ...
  function unlockFormFields() {
    ...
    var fields = ["expct", "excss", "lack", "rework", "sample", "good", "ng", "automach", "plant", "inspectDate", "details", "upd", "registrant", "insp1", "insp2", "insp3", "insp4", "insp5"];
  ...
  function initGoodNgInputs() {
    document.getElementById("excss").addEventListener("keydown", function () {
      if (event.key === "Enter") {
        event.preventDefault();
        if (document.getElementById("excss").value.trim() === "") {
          Livewire.dispatch("setExcssQty", {
            value: 0
          });
        }
        var excssValue = parseFloat(document.getElementById("excss").value) || 0;
        if (excssValue !== 0) {
    ...
    document.getElementById("lack").addEventListener("keydown", function () {
      if (event.key === "Enter") {
        event.preventDefault();
        if (document.getElementById("lack").value.trim() === "") {
          Livewire.dispatch("setlack", {
            value: 0
          });
        }
        document.getElementById("rework").focus();
    ...
    document.getElementById("rework").addEventListener("keydown", function () {
      if (event.key === "Enter") {
        event.preventDefault();
        if (document.getElementById("rework").value.trim() === "") {
          Livewire.dispatch("setrework", {
            value: 0
          });
        }
    ...
    document.getElementById("sample").addEventListener("keydown", function () {
      if (event.key === "Enter") {
        event.preventDefault();
        if (document.getElementById("sample").value.trim() === "") {
          Livewire.dispatch("setsample", {
            value: 0
          });
        }
        document.getElementById("GoodNg").click();
